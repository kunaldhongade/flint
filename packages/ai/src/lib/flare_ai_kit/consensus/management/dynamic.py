...
class DynamicInteractionManager:
    ...
    def __init__(
        self,
        communication_manager:Union[ CommunicationManager, None ]= None,
    ...
    async def select_interaction_pattern(
        ...
        task_complexity:Union[ TaskComplexity, None ]= None,
    ...
    async def _coordinate_broadcast(
        ...
        for agent, result in zip(agents, results, strict=False):
            if result != "timeout" and not isinstance(result, Exception):
                ...
                prediction_value:Union[ str, float ]= (
    ...
    async def _coordinate_hierarchical(
        ...
        for group in groups:
            ...
            # Select group leader Union[highest performing agent]
            leader = max(
                group,
    ...
    async def _coordinate_peer_to_peer(
        ...
        for pair in review_pairs:
            ...
            if pred_1 and pred_2:
                ...
                pred_1_value:Union[ str, float ]= (
                    str(reviewed_1)
                    if not isinstance(reviewed_1, (str, int, float))
                    else reviewed_1
                )
                pred_2_value:Union[ str, float ]= (
                    str(reviewed_2)
