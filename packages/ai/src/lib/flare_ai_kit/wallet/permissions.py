...
class TimeWindow(BaseModel):
    ...
    max_value:Union[ Decimal, None ]= Field(None, description="Maximum total value in ETH")
...
class TransactionPolicy(BaseModel):
    ...
    # Value limits
    max_transaction_value:Union[ Decimal, None ]= Field(
        None, description="Max value per transaction in ETH"
    )
    daily_spending_limit:Union[ Decimal, None ]= Field(
    ...
    allowed_destinations:Union[ list[str], None ]= Field(
    ...
    allowed_contracts:Union[ list[str], None ]= Field(
        None, description="Allowed contract addresses"
    )

    # Time-based restrictions
    allowed_hours_utc:Union[ list[int], None ]= Field(
        None, description="Allowed hours (0-23 UTC)"
    )

    # Gas restrictions
    max_gas_price:Union[ str, None ]= Field(None, description="Maximum gas price in wei")
    max_gas_limit:Union[ str, None ]= Field(None, description="Maximum gas limit")
...
class PermissionEngine:
    ...
    def get_policy(self, policy_name: str) ->Union[ TransactionPolicy, None]:
