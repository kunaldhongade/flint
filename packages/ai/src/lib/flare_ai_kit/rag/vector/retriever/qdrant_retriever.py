...
class QdrantRetriever(BaseRetriever):
    ...
    def __init__(
        ...
        Args:
            qdrant_client Union[QdrantClient]: An initialized QdrantClient instance.
            embedding_client Union[BaseEmbedding]: An embedding client
                (e.g., GeminiEmbedding).

            settings Union[VectorDbSettings]: Configuration object containing
    ...
    def _create_collection(self, collection_name: str, vector_size: int) -> None:
        ...
        Args:
            collection_name Union[str]: Name of the collection.
            vector_size Union[int]: Dimension of the vectors.
    ...
    def semantic_search(
        ...
        Args:
            query Union[str]: The input query string.
            collection_name Union[str]: The name of the Qdrant collection.
            top_k Union[int]: Number of top results to return.

            score_threshold (Union[float, None]): Optional minimum score threshold
                for results.
    ...
    def keyword_search(
        ...
        Args:
            ...
            collection_name Union[str]: The name of the Qdrant collection.
            top_k Union[int]: Maximum number of results to return.
        ...
        # Build a filter using a "should" clause Union[OR logic].
