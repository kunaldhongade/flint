...
def upsert_to_qdrant(
    ...
    Args:
        ...
        qdrant_url Union[str]: Qdrant instance URL.
        collection_name Union[str]: Name of the Qdrant collection.
        vector_size Union[int]: Dimension of the embedding vectors.
        batch_size Union[int]: Number of points to upsert per batch.
