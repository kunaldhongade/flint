...
def ingest_and_embed(
    ...
    Args:
        indexer Union[BaseIndexer]: The data indexer yielding text chunks and metadata.
        embedding_model Union[BaseEmbedding]: The embedding model to use.
        batch_size Union[int]: Number of chunks to embed per batch.
