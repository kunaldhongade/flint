...
class FileContent(BaseModel):
    ...
    mime_type:Union[ str, None ]= Field(default=None, alias="mimeType")
...
class PushNotificationConfig(BaseModel):
    ...
    authentication:Union[ PushNotificationAuthenticationInfo, None ]= None
...
class MessageSendConfiguration(BaseModel):
    ...
    history_length:Union[ int, None ]= Field(default=0, alias="historyLength")
    push_notification_config:Union[ PushNotificationConfig, None ]= Field(
...
class Message(BaseModel):
    ...
    context_id:Union[ str, None ]= Field(default=None, alias="contextId")
    task_id:Union[ str, None ]= Field(default=None, alias="taskId")
...
class Artifact(BaseModel):
    ...
    last_chunk:Union[ bool, None ]= Field(default=None, alias="lastChunk")
...
class Task(BaseModel):
    ...
    context_id:Union[ str, None ]= Field(default=None, alias="contextId")
    status: TaskStatus
    artifacts:Union[ list[Artifact], None ]= None
    history:Union[ list[Message], None ]= None
    metadata:Union[ dict[str, Any], None ]= None
...
class TaskQueryParams(TaskIdParams):
    ...
    history_length:Union[ int, None ]= Field(default=None, alias="historyLength")
...
class MessageSendParams(BaseModel):
    ...
    message: Message
    configuration:Union[ MessageSendConfiguration, None ]= None
    metadata:Union[ dict[str, Any], None ]= None
...
class SendMessageResponse(JSONRPCResponse):
    ...
    result:Union[Task, Message , None] = None


class SendStreamingMessageResponse(JSONRPCResponse):
    """JSON-RPC response for streaming message operations."""

    result: Union[Message, Task, TaskStatusUpdateEvent, TaskArtifactUpdateEvent, None] = None
...
class SetTaskPushNotificationResponse(JSONRPCResponse):
    ...
    result:Union[ TaskPushNotificationConfig, None ]= None
...
class AgentSkill(BaseModel):
    ...
    input_modes:Union[ list[str], None ]= Field(default=None, alias="inputModes")
    output_modes:Union[ list[str], None ]= Field(default=None, alias="outputModes")
...
class AgentCard(BaseModel):
    ...
    url: str
    version: str
    provider:Union[ AgentProvider, None ]= None
    documentation_url:Union[ str, None ]= Field(default=None, alias="documentationUrl")
    capabilities: AgentCapabilities
    authentication:Union[ AgentAuthentication, None ]= None
