...
class AgentWalletConfig(BaseModel):
    ...
    allowed_hours: list[int] = Field(
        ...
        description="Allowed operation hours Union[UTC]",
    )
...
class TurnkeyAgentConnector:
    ...
    async def execute_agent_transaction(  # noqa: PLR0911
        ...
        attestation_token:Union[ str, None ]= None,
    ) -> dict[str, Any]:
        """
    ...
    async def get_agent_status(self, agent_id: str) ->Union[ dict[str, Any], None]:
        """
        ...
        # Get recent transaction activity Union[last 24 hours]
    ...
    async def get_transaction_history(
        self, agent_id:Union[ str, None ]= None, limit: int = 100
    ) -> list[dict[str, Any]]:
        """
        ...
        # Sort by timestamp Union[most recent first] and apply limit
