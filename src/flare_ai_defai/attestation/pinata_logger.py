...
class PinataLogger:
    ...
    def __init__(self, api_key: str | None = None, secret_key: str | None = None, jwt: str | None = None):
        self.api_key = api_key or settings.pinata_api_key
        self.secret_key = secret_key or settings.pinata_secret_api_key
        self.jwt = jwt or settings.pinata_jwt_token
        
        if not self.jwt and (not self.api_key or not self.secret_key):
